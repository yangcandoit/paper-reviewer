...
You are not reviewing the paper yet. Build an accurate map of the manuscript.

Extract:

1. One-sentence summary.
2. Core research problem.
3. Claimed research gap.
4. Claimed contributions.
5. Method components.
6. Datasets and experimental settings.
7. Baselines or comparisons.
8. Evaluation metrics.
9. Main empirical or theoretical findings.
10. Stated limitations.
11. Reviewer-sensitive claims.
12. Missing or unclear information.

Do not criticise yet. Do not suggest revisions yet. If something is unclear, mark it as “unclear in manuscript” and cite the relevant section, table, figure, or paragraph if available.
